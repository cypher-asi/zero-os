...
1. Initialize WebGPU device and surface (`apps/zos-supervisor/src/desktop/engine.ts`)
...
1. Create `WindowManager` class (`apps/zos-supervisor/src/desktop/windows.ts`)
...
1. Create `InputRouter` class (`apps/zos-supervisor/src/desktop/input.ts`)
...
1. Create `WindowContent` bridge component (`apps/zos-supervisor/src/desktop/WindowContent.tsx`)
