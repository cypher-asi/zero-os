...
- Demonstrate the `OrbitalApp` trait and framework
...
```rust
// crates/orbital-apps/src/bin/clock.rs
...
```rust
// crates/orbital-apps/src/bin/calculator.rs
...
impl OrbitalApp for CalculatorApp {
    fn manifest() -> &'static AppManifest {
        &CALCULATOR_MANIFEST
    }
