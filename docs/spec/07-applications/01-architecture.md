...
This document specifies the platform-agnostic application model for Orbital OS:
...
All Orbital applications implement this trait:
...
│  ┌─────────────────────────────────────────────────────────────┐│
│  │ WASM Runtime                                                 ││
│  │ ├── orbital-apps crate compiled to wasm32                    ││
...
| Source | `crates/orbital-apps/` | External (future) |
