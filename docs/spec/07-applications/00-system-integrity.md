...
This document specifies the core architectural invariant of Orbital OS: the Axiom-first architecture. Every state-mutating operation must pass through the Axiom Gateway to ensure deterministic replay and complete audit trails.
