...
<body>
    <div id="terminal"></div>
    <script type="module">
        import { OrbitalSupervisor } from './supervisor.js';
        
        const supervisor = new OrbitalSupervisor();
...
fn main(handle: Handle, mut system_table: SystemTable<Boot>) -> Status {
    ...
    let kernel_data = load_file(&mut root, "\\orbital\\kernel.elf");
