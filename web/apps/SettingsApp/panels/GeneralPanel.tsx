    ...
    <div className={styles.panelContainer}>
      ...
      >
        <div className={styles.menuContent}>
          <Menu items={timeFormatItems} value={timeFormat24h ? '24h' : '12h'} onChange={handleTimeFormatSelect} background="none" border="none" />
        </div>
      </GroupCollapsible>
      ...
      >
        <div className={styles.menuContent}>
          <Menu items={timezoneItems} value={timezone} onChange={onTimezoneChange} background="none" border="none" />
        </div>
      </GroupCollapsible>
    </div>
  );
