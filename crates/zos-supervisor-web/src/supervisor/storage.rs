...
impl super::Supervisor {
    ...
    pub(super) fn notify_storage_list_complete_internal(&mut self, request_id: u32, keys_json: &str) {
        log(&format!(
    ...
    pub(super) fn notify_storage_exists_complete_internal(&mut self, request_id: u32, exists: bool) {
        log(&format!(
