...
//! See `orbital-apps` for the canonical OrbitalApp implementations.
...
// Re-export background renderer from orbital-desktop for convenience
pub use orbital_desktop::background as desktop_background;
