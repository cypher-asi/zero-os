//! Calculator State
//!
//! Serialization for Calculator app state sent to UI.

use crate::protocol::type_tags::TYPE_CALCULATOR_STATE;
use crate::protocol::{
    decode_optional_char, decode_string, decode_u8, encode_optional_char, encode_string,
...
impl CalculatorState {
    ...
    pub fn from_bytes(data: &[u8]) -> Result<Self, ProtocolError> {
        ...
        if payload[0] != TYPE_CALCULATOR_STATE {
            return Err(ProtocolError::UnexpectedType {
                expected: TYPE_CALCULATOR_STATE,
                got: payload[0],
            });
