...
/// Object types that capabilities can reference (matches orbital-kernel)
...
impl AppManifest {
    ...
    pub fn is_factory_app(&self) -> bool {
        self.id.starts_with("com.orbital.")
    }
}
...
pub static TERMINAL_MANIFEST: AppManifest = AppManifest {
    id: "com.orbital.terminal",
    name: "Terminal",
    version: "1.0.0",
    description: "Command-line interface for Orbital OS",
    capabilities: &[
        CapabilityRequest {
...
pub static PERMISSION_MANAGER_MANIFEST: AppManifest = AppManifest {
    id: "com.orbital.permission_manager",
