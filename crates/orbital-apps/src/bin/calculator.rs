...
use orbital_apps::app_protocol::{tags, CalculatorState, InputEvent};
use orbital_apps::manifest::CALCULATOR_MANIFEST;
...
fn main() {
    println!("Calculator app is meant to run as WASM in Orbital OS");
}
