//! Orbital OS Application Framework
//!
//! This crate provides the platform-agnostic application model for Orbital OS:
//!
//! - **OrbitalApp trait**: The interface all apps implement
...
pub use app::{AppContext, ControlFlow, Message, OrbitalApp};
pub use app_protocol::tags;
pub use error::{AppError, ProtocolError};
pub use manifest::{AppManifest, CapabilityRequest};
pub use runtime::AppRuntime;

// Re-export syscall interface from orbital-process
pub use orbital_process as syscall;
...
///
/// ```ignore
/// use orbital_apps::{app_main, OrbitalApp};
///
/// #[derive(Default)]
/// struct MyApp;
///
