...
/// Worker message types for non-syscall events.
///
/// Syscalls use the SharedArrayBuffer polling path (poll_syscalls) instead of postMessage.
#[derive(Clone, Debug)]
...
///
/// Handles non-syscall worker events. Syscalls use SharedArrayBuffer polling.
#[allow(dead_code)]
